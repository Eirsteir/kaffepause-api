...
def test_get_friendships_for_when_user_has_no_friendships(
...
def test_friendships_exists_excluding_status_asymmetrical(friendships):
...
def test_friendships_exists_including_status_asymmetrical(friendships):
...
def test_friendships_exists_excluding_status_symmetrical(friendships):
...
def test_friendships_exists_including_status_symmetrical(friendships):
...
def test_get_single_friendships_excluding_status(friendships):
...
def test_get_single_friendships_including_status(friendships):
